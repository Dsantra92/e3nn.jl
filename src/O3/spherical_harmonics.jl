...
function _spherical_harmonics(
    ...
    if lmax == 0
        return stack([sh_0_0], dims = ndims(x) + 1)
    end
    ...
    sh_1_2 = sqrt(3) * z
    if lmax == 1
        return stack([sh_0_0, sh_1_0, sh_1_1, sh_1_2], dims = ndims(sh_0_0) + 1)
    end
    ...
    y2 = y .^ 2
    x2z2 = x .^ 2 + z .^ 2
    sh_2_2 = sqrt(5) * (y2 - (1 / 2) * x2z2)
    sh_2_3 = sqrt(15) * y * z
    sh_2_4 = (1 / 2) * sqrt(15) * (z .^ 2 - x .^ 2)
    ...
    sh_3_1 = sqrt(7) * sh_2_0 * y
    sh_3_2 = (1 / 8) * sqrt(168) * (4.0 * y2 - x2z2) * x
    sh_3_3 = (1 / 2) * sqrt(7) * y * (2.0 * y2 - 3.0 * x2z2)
    sh_3_4 = (1 / 8) * sqrt(168) * z * (4.0 * y2 - x2z2)
    sh_3_5 = sqrt(7) * sh_2_4 * y
    sh_3_6 = (1 / 6) * sqrt(42) * (sh_2_4 * z - sh_2_0 * x)
    ...
    sh_4_2 = (
        ...
        (3 / 56) * sqrt(210) * sh_3_2 * z +
        (3 / 56) * sqrt(210) * sh_3_4 * x +
        (3 / 56) * sqrt(14) * sh_3_6 * x
    )
    sh_4_3 = (
        -3 / 56 * sqrt(42) * sh_3_1 * z +
        (3 / 28) * sqrt(105) * sh_3_2 * y +
    ...
    sh_4_5 = (
        ...
        (3 / 28) * sqrt(105) * sh_3_4 * y - 3 / 56 * sqrt(42) * sh_3_5 * z
    )
    sh_4_6 = (
        -3 / 56 * sqrt(14) * sh_3_0 * x - 3 / 56 * sqrt(210) * sh_3_2 * x +
    ...
    sh_5_2 = (
        ...
        (1 / 15) * sqrt(154) * sh_4_2 * z +
        (1 / 15) * sqrt(154) * sh_4_6 * x +
        (1 / 30) * sqrt(22) * sh_4_8 * x
    )
    sh_5_3 = (
        -1 / 30 * sqrt(66) * sh_4_1 * z +
        (1 / 15) * sqrt(231) * sh_4_2 * y +
        (1 / 30) * sqrt(462) * sh_4_3 * z +
        (1 / 30) * sqrt(462) * sh_4_5 * x +
        (1 / 30) * sqrt(66) * sh_4_7 * x
    )
    sh_5_4 = (
        -1 / 15 * sqrt(33) * sh_4_2 * z +
        (2 / 15) * sqrt(66) * sh_4_3 * y +
        (1 / 15) * sqrt(165) * sh_4_4 * x +
        (1 / 15) * sqrt(33) * sh_4_6 * x
    )
    sh_5_5 = (
        -1 / 15 * sqrt(110) * sh_4_3 * x + (1 / 3) * sqrt(11) * sh_4_4 * y -
        1 / 15 * sqrt(110) * sh_4_5 * z
    )
    sh_5_6 = (
        -1 / 15 * sqrt(33) * sh_4_2 * x +
        (1 / 15) * sqrt(165) * sh_4_4 * z +
        (2 / 15) * sqrt(66) * sh_4_5 * y - 1 / 15 * sqrt(33) * sh_4_6 * z
    )
    sh_5_7 = (
        -1 / 30 * sqrt(66) * sh_4_1 * x - 1 / 30 * sqrt(462) * sh_4_3 * x +
        (1 / 30) * sqrt(462) * sh_4_5 * z +
        (1 / 15) * sqrt(231) * sh_4_6 * y - 1 / 30 * sqrt(66) * sh_4_7 * z
    )
    sh_5_8 = (
        -1 / 30 * sqrt(22) * sh_4_0 * x - 1 / 15 * sqrt(154) * sh_4_2 * x +
    ...
    sh_6_1 = (
        (1 / 6) * sqrt(13) * sh_5_0 * y +
        (1 / 12) * sqrt(130) * sh_5_1 * z +
        (1 / 12) * sqrt(130) * sh_5_9 * x
    )
    sh_6_2 = (
        -1 / 132 * sqrt(286) * sh_5_0 * z +
        (1 / 33) * sqrt(715) * sh_5_1 * y +
        (1 / 132) * sqrt(286) * sh_5_10 * x +
        (1 / 44) * sqrt(1430) * sh_5_2 * z +
        (1 / 44) * sqrt(1430) * sh_5_8 * x
    )
    sh_6_3 = (
        -1 / 132 * sqrt(858) * sh_5_1 * z +
        (1 / 22) * sqrt(429) * sh_5_2 * y +
        (1 / 22) * sqrt(286) * sh_5_3 * z +
        (1 / 22) * sqrt(286) * sh_5_7 * x +
        (1 / 132) * sqrt(858) * sh_5_9 * x
    )
    sh_6_4 = (
        -1 / 66 * sqrt(429) * sh_5_2 * z +
        (2 / 33) * sqrt(286) * sh_5_3 * y +
        (1 / 66) * sqrt(2002) * sh_5_4 * z +
        (1 / 66) * sqrt(2002) * sh_5_6 * x +
        (1 / 66) * sqrt(429) * sh_5_8 * x
    )
    sh_6_5 = (
        -1 / 66 * sqrt(715) * sh_5_3 * z +
        (1 / 66) * sqrt(5005) * sh_5_4 * y +
        (1 / 66) * sqrt(3003) * sh_5_5 * x +
        (1 / 66) * sqrt(715) * sh_5_7 * x
    )
    sh_6_6 = (
        -1 / 66 * sqrt(2145) * sh_5_4 * x + (1 / 11) * sqrt(143) * sh_5_5 * y -
        1 / 66 * sqrt(2145) * sh_5_6 * z
    )
    sh_6_7 = (
        -1 / 66 * sqrt(715) * sh_5_3 * x +
        (1 / 66) * sqrt(3003) * sh_5_5 * z +
        (1 / 66) * sqrt(5005) * sh_5_6 * y - 1 / 66 * sqrt(715) * sh_5_7 * z
    )
    sh_6_8 = (
        -1 / 66 * sqrt(429) * sh_5_2 * x - 1 / 66 * sqrt(2002) * sh_5_4 * x +
        (1 / 66) * sqrt(2002) * sh_5_6 * z +
        (2 / 33) * sqrt(286) * sh_5_7 * y - 1 / 66 * sqrt(429) * sh_5_8 * z
    )
    sh_6_9 = (
        -1 / 132 * sqrt(858) * sh_5_1 * x - 1 / 22 * sqrt(286) * sh_5_3 * x +
        (1 / 22) * sqrt(286) * sh_5_7 * z +
        (1 / 22) * sqrt(429) * sh_5_8 * y - 1 / 132 * sqrt(858) * sh_5_9 * z
    )
    sh_6_10 = (
        -1 / 132 * sqrt(286) * sh_5_0 * x - 1 / 132 * sqrt(286) * sh_5_10 * z -
        1 / 44 * sqrt(1430) * sh_5_2 * x +
        (1 / 44) * sqrt(1430) * sh_5_8 * z +
        (1 / 33) * sqrt(715) * sh_5_9 * y
    )
    sh_6_11 = (
        -1 / 12 * sqrt(130) * sh_5_1 * x +
        (1 / 6) * sqrt(13) * sh_5_10 * y +
        (1 / 12) * sqrt(130) * sh_5_9 * z
    )
    ...
    sh_7_2 = (
        ...
        (3 / 91) * sqrt(715) * sh_6_10 * x +
        (1 / 182) * sqrt(390) * sh_6_12 * x +
        (3 / 91) * sqrt(715) * sh_6_2 * z
    )
    sh_7_3 = (
        -3 / 182 * sqrt(130) * sh_6_1 * z +
        (3 / 182) * sqrt(130) * sh_6_11 * x +
        (3 / 91) * sqrt(715) * sh_6_2 * y +
        (5 / 182) * sqrt(858) * sh_6_3 * z +
        (5 / 182) * sqrt(858) * sh_6_9 * x
    )
    sh_7_4 = (
        (3 / 91) * sqrt(65) * sh_6_10 * x - 3 / 91 * sqrt(65) * sh_6_2 * z +
        (10 / 91) * sqrt(78) * sh_6_3 * y +
        (15 / 182) * sqrt(78) * sh_6_4 * z +
        (15 / 182) * sqrt(78) * sh_6_8 * x
    )
    sh_7_5 = (
        -5 / 91 * sqrt(39) * sh_6_3 * z +
        (15 / 91) * sqrt(39) * sh_6_4 * y +
        (3 / 91) * sqrt(390) * sh_6_5 * z +
        (3 / 91) * sqrt(390) * sh_6_7 * x +
        (5 / 91) * sqrt(39) * sh_6_9 * x
    )
    sh_7_6 = (
        -15 / 182 * sqrt(26) * sh_6_4 * z +
        (12 / 91) * sqrt(65) * sh_6_5 * y +
        (2 / 91) * sqrt(1365) * sh_6_6 * x +
        (15 / 182) * sqrt(26) * sh_6_8 * x
    )
    sh_7_7 = (
        -3 / 91 * sqrt(455) * sh_6_5 * x + (1 / 13) * sqrt(195) * sh_6_6 * y -
        3 / 91 * sqrt(455) * sh_6_7 * z
    )
    sh_7_8 = (
        -15 / 182 * sqrt(26) * sh_6_4 * x +
        (2 / 91) * sqrt(1365) * sh_6_6 * z +
        (12 / 91) * sqrt(65) * sh_6_7 * y - 15 / 182 * sqrt(26) * sh_6_8 * z
    )
    sh_7_9 = (
        -5 / 91 * sqrt(39) * sh_6_3 * x - 3 / 91 * sqrt(390) * sh_6_5 * x +
        (3 / 91) * sqrt(390) * sh_6_7 * z +
        (15 / 91) * sqrt(39) * sh_6_8 * y - 5 / 91 * sqrt(39) * sh_6_9 * z
    )
    sh_7_10 = (
        -3 / 91 * sqrt(65) * sh_6_10 * z - 3 / 91 * sqrt(65) * sh_6_2 * x -
        15 / 182 * sqrt(78) * sh_6_4 * x +
        (15 / 182) * sqrt(78) * sh_6_8 * z +
        (10 / 91) * sqrt(78) * sh_6_9 * y
    )
    sh_7_11 = (
        -3 / 182 * sqrt(130) * sh_6_1 * x + (3 / 91) * sqrt(715) * sh_6_10 * y -
        3 / 182 * sqrt(130) * sh_6_11 * z - 5 / 182 * sqrt(858) * sh_6_3 * x +
        (5 / 182) * sqrt(858) * sh_6_9 * z
    )
    sh_7_12 = (
        -1 / 182 * sqrt(390) * sh_6_0 * x +
        (3 / 91) * sqrt(715) * sh_6_10 * z +
    ...
    sh_8_1 = (
        (1 / 8) * sqrt(17) * sh_7_0 * y +
        (1 / 16) * sqrt(238) * sh_7_1 * z +
        (1 / 16) * sqrt(238) * sh_7_13 * x
    )
    sh_8_2 = (
        -1 / 240 * sqrt(510) * sh_7_0 * z +
        (1 / 60) * sqrt(1785) * sh_7_1 * y +
        (1 / 240) * sqrt(46410) * sh_7_12 * x +
        (1 / 240) * sqrt(510) * sh_7_14 * x +
        (1 / 240) * sqrt(46410) * sh_7_2 * z
    )
    sh_8_3 = (
        (1 / 80) *
        sqrt(2) *
    ...
    sh_8_4 = (
        (1 / 40) * sqrt(935) * sh_7_10 * x + (1 / 40) * sqrt(85) * sh_7_12 * x -
        1 / 40 * sqrt(85) * sh_7_2 * z +
        (1 / 10) * sqrt(85) * sh_7_3 * y +
        (1 / 40) * sqrt(935) * sh_7_4 * z
    )
    sh_8_5 = (
        (1 / 48) *
        sqrt(2) *
        (
            sqrt(102) * sh_7_11 * x - sqrt(102) * sh_7_3 * z +
            sqrt(1122) * sh_7_4 * y +
            sqrt(561) * sh_7_5 * z +
            sqrt(561) * sh_7_9 * x
        )
    ...
    sh_8_6 = (
        (1 / 16) * sqrt(34) * sh_7_10 * x - 1 / 16 * sqrt(34) * sh_7_4 * z +
        (1 / 4) * sqrt(17) * sh_7_5 * y +
        (1 / 16) * sqrt(102) * sh_7_6 * z +
        (1 / 16) * sqrt(102) * sh_7_8 * x
    )
    sh_8_7 = (
        -1 / 80 * sqrt(1190) * sh_7_5 * z +
        (1 / 40) * sqrt(1785) * sh_7_6 * y +
        (1 / 20) * sqrt(255) * sh_7_7 * x +
        (1 / 80) * sqrt(1190) * sh_7_9 * x
    )
    sh_8_8 = (
        -1 / 60 * sqrt(1785) * sh_7_6 * x + (1 / 15) * sqrt(255) * sh_7_7 * y -
        1 / 60 * sqrt(1785) * sh_7_8 * z
    )
    sh_8_9 = (
        -1 / 80 * sqrt(1190) * sh_7_5 * x +
        (1 / 20) * sqrt(255) * sh_7_7 * z +
        (1 / 40) * sqrt(1785) * sh_7_8 * y - 1 / 80 * sqrt(1190) * sh_7_9 * z
    )
    sh_8_10 = (
        -1 / 16 * sqrt(34) * sh_7_10 * z - 1 / 16 * sqrt(34) * sh_7_4 * x -
        1 / 16 * sqrt(102) * sh_7_6 * x +
        (1 / 16) * sqrt(102) * sh_7_8 * z +
        (1 / 4) * sqrt(17) * sh_7_9 * y
    )
    sh_8_11 = (
        (1 / 48) *
        sqrt(2) *
    ...
    sh_8_12 = (
        (1 / 40) * sqrt(935) * sh_7_10 * z + (1 / 10) * sqrt(85) * sh_7_11 * y -
        1 / 40 * sqrt(85) * sh_7_12 * z - 1 / 40 * sqrt(85) * sh_7_2 * x -
        1 / 40 * sqrt(935) * sh_7_4 * x
    )
    sh_8_13 = (
        (1 / 80) *
        sqrt(2) *
    ...
    sh_8_15 = (
        -1 / 16 * sqrt(238) * sh_7_1 * x +
        (1 / 16) * sqrt(238) * sh_7_13 * z +
        (1 / 8) * sqrt(17) * sh_7_14 * y
    )
    ...
    sh_9_2 = (
        ...
        (2 / 153) * sqrt(4845) * sh_8_14 * x +
        (1 / 306) * sqrt(646) * sh_8_16 * x +
        (2 / 153) * sqrt(4845) * sh_8_2 * z
    )
    sh_9_3 = (
        -1 / 306 * sqrt(1938) * sh_8_1 * z +
        (1 / 306) * sqrt(67830) * sh_8_13 * x +
        (1 / 306) * sqrt(1938) * sh_8_15 * x +
        (1 / 51) * sqrt(1615) * sh_8_2 * y +
    ...
    sh_10_1 = (
        (1 / 10) * sqrt(21) * sh_9_0 * y +
        (3 / 20) * sqrt(42) * sh_9_1 * z +
        (3 / 20) * sqrt(42) * sh_9_17 * x
    )
    sh_10_2 = (
        -1 / 380 * sqrt(798) * sh_9_0 * z +
        (3 / 95) * sqrt(399) * sh_9_1 * y +
        (3 / 380) * sqrt(13566) * sh_9_16 * x +
        (1 / 380) * sqrt(798) * sh_9_18 * x +
        (3 / 380) * sqrt(13566) * sh_9_2 * z
    )
    sh_10_3 = (
        -3 / 380 * sqrt(266) * sh_9_1 * z +
        (1 / 95) * sqrt(6783) * sh_9_15 * x +
        (3 / 380) * sqrt(266) * sh_9_17 * x +
        (3 / 190) * sqrt(2261) * sh_9_2 * y +
    ...
    sh_10_9 = (
        (3 / 190) * sqrt(798) * sh_9_11 * x - 3 / 190 * sqrt(798) * sh_9_7 * z +
        (3 / 190) * sqrt(4389) * sh_9_8 * y +
    ...
    sh_10_18 = (
        -1 / 380 * sqrt(798) * sh_9_0 * x +
        (3 / 380) * sqrt(13566) * sh_9_16 * z +
        (3 / 95) * sqrt(399) * sh_9_17 * y - 1 / 380 * sqrt(798) * sh_9_18 * z -
        3 / 380 * sqrt(13566) * sh_9_2 * x
    )
    sh_10_19 = (
        -3 / 20 * sqrt(42) * sh_9_1 * x +
        (3 / 20) * sqrt(42) * sh_9_17 * z +
        (1 / 10) * sqrt(21) * sh_9_18 * y
    )
    ...
    sh_11_1 = (
        (1 / 11) * sqrt(23) * sh_10_0 * y +
        (1 / 11) * sqrt(115) * sh_10_1 * z +
        (1 / 11) * sqrt(115) * sh_10_19 * x
    )
    sh_11_2 = (
        -1 / 462 * sqrt(966) * sh_10_0 * z +
        (2 / 231) * sqrt(4830) * sh_10_1 * y +
        (1 / 231) * sqrt(45885) * sh_10_18 * x +
        (1 / 231) * sqrt(45885) * sh_10_2 * z +
        (1 / 462) * sqrt(966) * sh_10_20 * x
    )
    sh_11_3 = (
        -1 / 154 * sqrt(322) * sh_10_1 * z +
        (1 / 154) * sqrt(18354) * sh_10_17 * x +
        (1 / 154) * sqrt(322) * sh_10_19 * x +
        (1 / 77) * sqrt(3059) * sh_10_2 * y +
    ...
    sh_11_21 = (
        -1 / 11 * sqrt(115) * sh_10_1 * x +
        (1 / 11) * sqrt(115) * sh_10_19 * z +
        (1 / 11) * sqrt(23) * sh_10_20 * y
    )
    ...
    sh_12_2 = (
        ...
        (5 / 552) * sqrt(10626) * sh_11_2 * z +
        (5 / 552) * sqrt(10626) * sh_11_20 * x +
        (5 / 552) * sqrt(46) * sh_11_22 * x
    )
    sh_12_3 = (
        -5 / 552 * sqrt(138) * sh_11_1 * z +
        (5 / 276) * sqrt(2415) * sh_11_19 * x +
        (5 / 92) * sqrt(161) * sh_11_2 * y +
        (5 / 552) * sqrt(138) * sh_11_21 * x +
    ...
    sh_12_18 = (
        ...
        sqrt(3) *
        (
            sqrt(2346) * sh_11_16 * z + 12 * sqrt(23) * sh_11_17 * y -
            sqrt(230) * sh_11_18 * z - sqrt(230) * sh_11_4 * x -
            sqrt(2346) * sh_11_6 * x
        )
    )
    sh_12_19 = (
